...
# user 1 is the 'training' - i.e the data that is inputted to the knn 
...
# # the subsample ones I don't know what to do to because they make the dataset smaller 
...
# models_list = ["offset36-model-more-dropout"]
...
# batch_size_list = [2**7, 2**6, 2**5]
# time_offsets_list = [50, 20, 10]
